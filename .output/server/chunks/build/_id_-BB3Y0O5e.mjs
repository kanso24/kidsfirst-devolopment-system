import { b as useToast, c as useRouter, d as useRoute, e as _sfc_main$d, f as _sfc_main$8 } from './server.mjs';
...
import { defineComponent, ref, reactive, mergeProps, unref, withCtx, createVNode, createTextVNode, toDisplayString, withModifiers, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const groupId = route.params.id ? parseInt(route.params.id) : null;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><div class="sm:flex sm:items-center sm:justify-between"><div><h1 class="text-2xl font-bold text-gray-900 dark:text-white">${ssrInterpolate(unref(isEditing) ? "Edit Question Group" : "Add New Question Group")}</h1><p class="mt-1 text-sm text-gray-500 dark:text-gray-400">${ssrInterpolate(unref(isEditing) ? "Update question group details" : "Create a new question group")}</p></div></div>`);
      if (unref(loading)) {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(unref(questions), (question, index) => {
                _push2(`<div class="mb-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg"${_scopeId}><div class="flex items-start justify-between gap-4 mb-3"${_scopeId}><span class="text-md font-medium"${_scopeId}>Question ${ssrInterpolate(index + 1)}</span>`);
                _push2(ssrRenderComponent(_component_UButton, {
                  type: "button",
                  size: "xs",
                  variant: "ghost",
                ...
                _push2(`<div class="grid grid-cols-6 gap-2 mt-3"${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(_component_UButton, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(unref(isEditing) ? "Update" : "Save")}`);
                  } else {
                    return [
                      createTextVNode(toDisplayString(unref(isEditing) ? "Update" : "Save"), 1)
                    ];
                  }
                }),
                _: 1
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(questions), (question, index) => {
                      return openBlock(), createBlock("div", {
                        ...
                        createVNode("div", { class: "flex items-start justify-between gap-4 mb-3" }, [
                          createVNode("span", { class: "text-md font-medium" }, "Question " + toDisplayString(index + 1), 1),
                          createVNode(_component_UButton, {
                            type: "button",
                            size: "xs",
                            variant: "ghost",
                        ...
                        createVNode("div", { class: "grid grid-cols-6 gap-2 mt-3" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/question-groups/edit/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-BB3Y0O5e.mjs.map
