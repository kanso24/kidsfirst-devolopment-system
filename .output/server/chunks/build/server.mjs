import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { useModel, computed, unref, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, inject, ref, hasInjectionContext, resolveDynamicComponent, useSlots, toRef, watch, provide, toValue, getCurrentInstance, onServerPrefetch, defineComponent, shallowRef, h, resolveComponent, isRef, nextTick, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, useTemplateRef, withModifiers, getCurrentScope, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { t as serialize, v as defu, w as klona, x as hasProtocol, y as isScriptProtocol, o as joinURL, z as isEqual, A as parseQuery, B as defuFn, C as withQuery, D as sanitizeStatusCode, E as parseURL, F as encodePath, G as decodePath, H as getRequestHeaders, I as getContext, c as createError$1, J as withTrailingSlash, K as withoutTrailingSlash, $ as $fetch$1, L as baseURL, M as executeAsync } from '../nitro/nitro.mjs';
...
import { Primitive, Slot, useForwardProps, createContext, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, useForwardPropsEmits, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ProgressRoot, ProgressIndicator } from 'reka-ui';
...
const _routes = [
  {
    name: "question-groups-edit-id",
    path: "/question-groups/edit/:id()",
    component: () => import('./_id_-BB3Y0O5e.mjs')
  },
  {
    name: "assessments-new",
    path: "/assessments/new",
    component: () => import('./new-CPoP0VZC.mjs')
  },
  {
    name: "question-groups-new",
    path: "/question-groups/new",
    component: () => import('./new-CxIDMTI-.mjs')
  },
  {
    name: "assessments-id",
    path: "/assessments/:id()",
    component: () => import('./_id_-DVUVsFSL.mjs'),
    children: [
      {
        name: "assessments-id-edit",
        path: "edit",
        component: () => import('./edit-D8_Pevqx.mjs')
      }
    ]
  },
  {
    name: "assessments",
    path: "/assessments",
    component: () => import('./index-DH9lWDI1.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-CSLfjabP.mjs')
  },
  {
    name: "question-groups",
    path: "/question-groups",
    component: () => import('./index-BklUUr6J.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./reports-BSm6JbiA.mjs')
  },
  {
    name: "students",
    path: "/students",
    component: () => import('./index-AH1H_XEh.mjs')
  },
  {
    name: "users",
    path: "/users",
    component: () => import('./index-BpRbCJwA.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CEY4yP0I.mjs')
  }
];
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-gnwlcIQa.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-B2VJ9VDG.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DLvao5nx.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CgCrrZne.mjs'));
...
export { isArrayOfArray as A, _sfc_main$c as B, getDisplayValue as C, inputIdInjectionKey as D, formFieldInjectionKey as E, defineKeyedFunctionFactory as F, fetchDefaults as G, useAsyncData as H, useRequestFetch as I, _sfc_main$9 as J, pickLinkProps as K, _sfc_main$a as L, omit as M, _export_sfc as _, __nuxt_component_0$1 as a, useToast as b, useRouter as c, useRoute as d, entry_default as default, _sfc_main$d as e, _sfc_main$8 as f, useAppConfig as g, useComponentUI as h, formBusInjectionKey as i, formStateInjectionKey as j, formErrorsInjectionKey as k, formInputsInjectionKey as l, formLoadingInjectionKey as m, navigateTo as n, formOptionsInjectionKey as o, useLocale as p, _sfc_main$b as q, useAuth as r, get as s, tv as t, useHead as u, useFormField as v, useComponentIcons as w, looseToNumber as x, usePortal as y, useFieldGroup as z };
