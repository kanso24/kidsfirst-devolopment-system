import { _ as _sfc_main$3 } from './Card-DknAj2mS.mjs';
import { r as useAuth, f as _sfc_main$8, e as _sfc_main$d, g as useAppConfig, h as useComponentUI, t as tv, i as formBusInjectionKey, j as formStateInjectionKey, k as formErrorsInjectionKey, l as formInputsInjectionKey, m as formLoadingInjectionKey, o as formOptionsInjectionKey, n as navigateTo, p as useLocale, q as _sfc_main$b } from './server.mjs';
import { defineComponent, reactive, ref, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, createCommentVNode, computed, useId, useTemplateRef, inject, provide, readonly, resolveDynamicComponent, renderSlot, useSlots, toDisplayString, Fragment, renderList, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrRenderList } from 'vue/server-renderer';
import { useEventBus } from '@vueuse/core';
import { Primitive } from 'reka-ui';
import { _ as _sfc_main$4 } from './FormField-DIh_xn5E.mjs';
import { _ as _sfc_main$5 } from './Input-eL64qsHE.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UCard, {
        class: "w-full",
        ui: { header: { padding: "p-6 sm:px-8" }, body: { padding: "p-6 sm:px-8" } }
      }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-center"${_scopeId}><div class="mx-auto h-12 w-12 bg-violet-100 dark:bg-violet-900/50 rounded-full flex items-center justify-center mb-4 text-violet-600 dark:text-violet-400"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "i-lucide-graduation-cap",
              class: "w-7 h-7"
            }, null, _parent2, _scopeId));
            _push2(`</div><h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight"${_scopeId}>Welcome back</h2><p class="text-sm text-gray-500 dark:text-gray-400 mt-2"${_scopeId}>Sign in to your account</p></div>`);
          } else {
            return [
              createVNode("div", { class: "text-center" }, [
                createVNode("div", { class: "mx-auto h-12 w-12 bg-violet-100 dark:bg-violet-900/50 rounded-full flex items-center justify-center mb-4 text-violet-600 dark:text-violet-400" }, [
                  createVNode(_component_UIcon, {
                    name: "i-lucide-graduation-cap",
                    class: "w-7 h-7"
                  })
                ]),
                createVNode("h2", { class: "text-2xl font-bold text-gray-900 dark:text-white tracking-tight" }, "Welcome back"),
                createVNode("p", { class: "text-sm text-gray-500 dark:text-gray-400 mt-2" }, "Sign in to your account")
              ])
            ];
          }
        }),
      ...
      _push(`<div class="mt-8 text-center text-sm text-gray-500 dark:text-gray-400"><p>admin / password123</p> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} KidsFirst Development System </div></div>`);
    };
  }
});
...
//# sourceMappingURL=login-CSLfjabP.mjs.map
