...
import { defineComponent, ref, reactive, withAsyncContext, watchEffect, watch, computed, mergeProps, unref, withCtx, createVNode, isRef, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: assessmentData, pending: assessmentPending } = ([__temp, __restore] = withAsyncContext(() => useFetch(
          ...
          if (groupId) {
            ...
            if (group) {
              ...
              group.questions?.forEach((q) => {
                const existingScore = ds.questionScores?.find((qs) => qs.questionText === q.questionText);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-6" }, _attrs))}><div class="sm:flex sm:items-center sm:justify-between"><div><h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Assessment</h1><p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update assessment for a student.</p></div></div>`);
      if (unref(assessmentPending)) {
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          variant: "ghost",
          size: "lg",
          onClick: ($event) => unref(router).push(`/assessments/${unref(assessmentId)}`)
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Cancel`);
        ...
        _push(ssrRenderComponent(_component_UButton, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`Update Assessment`);
            } else {
              return [
                createTextVNode("Update Assessment")
              ];
            }
          }),
          _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/assessments/[id]/edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit-D8_Pevqx.mjs.map
